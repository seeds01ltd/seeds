...
const MOCK = {
  ...
  services: [
    ...
    { id:'s3', slug:'cloud-devops', icon:'Cloud', title:'Cloud & DevOps', tagline:'Resilient infrastructure.', color:'#60a5fa', image:'https://images.unsplash.com/photo-1667372283536-a831e58cddef?auto=format&fit=crop&q=80&w=1200', description:'Cloud architecture, CI/CD, Kubernetes.', content:'<h2>Infrastructure as Code</h2>', tech:['AWS','GCP','Kubernetes','Terraform'], featured:true, order:3 },
